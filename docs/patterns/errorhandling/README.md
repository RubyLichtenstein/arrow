...
//kategory.OptionMonadErrorInstanceImplicits$instance$1@245d89f1
```

```kotlin
monadError<TryHK, Throwable>()
//kategory.TryMonadErrorInstanceImplicits$instance$1@1daaa13
```

```kotlin
monadError<EitherKindPartial<NukeException>, NukeException>()
//kategory.EitherMonadErrorInstanceImplicits$instance$1@43393929
```
